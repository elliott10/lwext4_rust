...
extern "C" {
    pub fn gettimeofday(tv: *mut timeval, tz: *mut timezone) -> ::core::ffi::c_int;
}
extern "C" {
...
extern "C" {
    pub fn stat(path: *const ::core::ffi::c_char, buf: *mut stat) -> ::core::ffi::c_int;
}
extern "C" {
    pub fn fstat(fd: ::core::ffi::c_int, buf: *mut stat) -> ::core::ffi::c_int;
}
extern "C" {
    pub fn lstat(path: *const ::core::ffi::c_char, buf: *mut stat) -> ::core::ffi::c_int;
}
extern "C" {
    pub fn fchmod(fd: ::core::ffi::c_int, mode: mode_t) -> ::core::ffi::c_int;
}
extern "C" {
    pub fn chmod(file: *const ::core::ffi::c_char, mode: mode_t) -> ::core::ffi::c_int;
}
extern "C" {
    pub fn mkdir(pathname: *const ::core::ffi::c_char, mode: mode_t) -> ::core::ffi::c_int;
}
extern "C" {
